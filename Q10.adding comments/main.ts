...
// Dated: 26/02/2024
// this program will run simple code just like to learn python Machine learning and dep learning
console.log('would you like learn python Machine learning and deep learning');